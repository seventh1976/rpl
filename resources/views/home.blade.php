      ...
      <div class="">
        ...
        <div class="panel-body text-center" style="margin-top: 4em">
          <h1>
            ...
            @role('Admin')
            <h4>Visit <a href="{{route('roles.index')}}"></a> and give permissions for each roles.<h4>
            @endrole

            <p>&nbsp;<br></p>
            <p>Assign different <code>roles</code> to users and login from different browsers <br> to see <code>access control</code> and <code>authorization</code> at work.</p>
        </div>
      </div>
    </div>
  </div>
